  ...
  return (
    <div className="bg-white">
      <div className="relative isolate px-4 sm:px-6 pt-10 sm:pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-16 sm:py-24 md:py-32 lg:py-40">
          ...
          <div className="text-center">
            <h1 className="text-balance text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-7xl">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-x-6">
              ...
              <Link
                to="/learn-more"
                className="w-full sm:w-auto text-sm leading-6 font-semibold text-gray-900"
              >
